...
'direct-fragment-shader': `#version 300 es
precision highp float;
...
'direct-vertex-shader': `#version 300 es
precision highp float;
...
'homovolume-fragment-shader': `#version 300 es
precision highp float;
                        ...
                        float wavelength_nm, in vec3 rgb, inout vec4 rnd)
{
    ...
    for (int vertex=0; vertex<=__MAX_BOUNCES__; ++vertex)
    {
        ...
        // Regular surface bounce case
        {
            ...
            vec3 surface_throughput = fOverPdf * abs(dot(woutputW, nW));
...
'homovolume-vertex-shader': `#version 300 es
precision highp float;
...
'simplepathtracer-withsss-fragment-shader': `#version 300 es
precision highp float;
