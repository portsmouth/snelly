...
* [GLU](#GLU) : <code>object</code>
    * [.this.Shader](#GLU.this.Shader)
        ...
        * [.this.Shader#uniform2F(name, f1, f2)](#GLU.this.Shader.this.Shader+uniform2F)
        * [.this.Shader#uniform1Fv(name, fvec)](#GLU.this.Shader.this.Shader+uniform1Fv)
        * [.this.Shader#uniform2Fv(name, fvec2)](#GLU.this.Shader.this.Shader+uniform2Fv)
        * [.this.Shader#uniform3F(name, f1, f2, f3)](#GLU.this.Shader.this.Shader+uniform3F)
        * [.this.Shader#uniform4F(name, f1, f2, f3, f4)](#GLU.this.Shader.this.Shader+uniform4F)
        * [.this.Shader#uniform4Fv(name, fvec4)](#GLU.this.Shader.this.Shader+uniform4Fv)
        * [.this.Shader#uniformMatrix4fv(name, matrixArray16)](#GLU.this.Shader.this.Shader+uniformMatrix4fv)
...
<a name="GLU.this.Shader.this.Shader+uniform2F"></a>

#### this.Shader.this.Shader#uniform2F(name, f1, f2)
...
<a name="GLU.this.Shader.this.Shader+uniform1Fv"></a>

#### this.Shader.this.Shader#uniform1Fv(name, fvec)
...
<a name="GLU.this.Shader.this.Shader+uniform2Fv"></a>

#### this.Shader.this.Shader#uniform2Fv(name, fvec2)
...
<a name="GLU.this.Shader.this.Shader+uniform3F"></a>

#### this.Shader.this.Shader#uniform3F(name, f1, f2, f3)
...
<a name="GLU.this.Shader.this.Shader+uniform4F"></a>

#### this.Shader.this.Shader#uniform4F(name, f1, f2, f3, f4)
...
<a name="GLU.this.Shader.this.Shader+uniform4Fv"></a>

#### this.Shader.this.Shader#uniform4Fv(name, fvec4)
...
<a name="GLU.this.Shader.this.Shader+uniformMatrix4fv"></a>

#### this.Shader.this.Shader#uniformMatrix4fv(name, matrixArray16)
